...
//	@Test
	...
	public static ParametersImpl createParameters(String serviceType) throws ParseException {
		...
		org.hl7.fhir.Date birthDate = FHIRUtil.convert(FHIRUtil.sdf.parse("2011-01-01T00:00:00"));
		...
		Patient patient0 = createPatient(gender, birthDate);
		...
		Patient patient1 = createPatient(gender, birthDate);
	 ...
	 static Patient createPatient(Code gender, org.hl7.fhir.Date birthDate) {
